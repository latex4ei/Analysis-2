...
$_{\text{\normalsize neg.}}^{\text{\normalsize pos.}}$ definit falls alle EW $\lambda \gtrless 0$\\
$_{\text{\normalsize neg.}}^{\text{\normalsize pos.}}$ semi definit falls alle EW $\lambda \gtreqless 0$\\
indefinit falls zwei EW $\lambda$ unterschiedliche VZ haben\\
...
% ==============================================================================================================
\section{Integration über Normalbereiche}
TODO
% ==============================================================================================================
...
\end{itemize}
Stammfunktion aufstellen: Mischung aus anstarren, integrieren, ableiten und gleichsetzen.
\if{0}
